...
@J2clTestInput(IntBufferTest.class)
public class IntBufferTest extends AbstractBufferTest {
  ...
  void assertContentEquals(IntBuffer buf, int array[], int offset, int length) {
    for (int i = 0; i < length; i++) {
  ...
  void assertContentLikeTestData1(IntBuffer buf, int startIndex, int startValue, int length) {
